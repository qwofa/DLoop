...
class ReleaseMetadataTests(unittest.TestCase):
    ...
    def test_current_materials_describe_current_scope(self) -> None:
        ...
        self.assertIn("## 3.4.2 - 2026-09-03", changelog)
        self.assertIn("## 3.4.1 - 2026-09-01", changelog)
    ...
    def test_current_source_is_presented_as_frozen(self) -> None:
        ...
        release_notes = (REPOSITORY_ROOT / "docs" / "v3.7.3-open-source-ci.md").read_text(encoding="utf-8")
        changelog = (REPOSITORY_ROOT / "CHANGELOG.md").read_text(encoding="utf-8")
