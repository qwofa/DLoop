...
class ReleaseMetadataTests(unittest.TestCase):
    ...
    def test_single_plugin_packages_both_explicit_skills_at_the_release_version(self) -> None:
        ...
        self.assertEqual("3.9.0", version)
    ...
    def test_current_materials_describe_current_scope(self) -> None:
        ...
        self.assertEqual("3.9.0", version)
        self.assertIn("v3.9.0", readme)
        self.assertIn("-Version v3.9.0", installation)
    ...
    def test_current_source_is_presented_as_frozen(self) -> None:
        ...
        release_notes = (REPOSITORY_ROOT / "docs" / "v3.9.0-acceptance-workflow.md").read_text(encoding="utf-8")

        self.assertEqual(
            {
                "workflowVersion": "3.9.0",
        ...
        self.assertIn("基于公开主线 v3.8.1", release_notes)
