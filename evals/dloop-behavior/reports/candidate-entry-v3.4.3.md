# DLoop 行为评测：candidate-v3.4.3-entry

- Skill 摘要：`sha256:7d242c157fa4bbe49e8ec33377add83f4b0ea086d281af423fcdd8fc55126aed`
- 执行模式：`model-protocol-dry-run`
- Trace 采集：`self-reported-semantic-trace`
- 静态材料表面：入口 5059 字节；references 39558 字节；合计 44866 字节（不等同于实际上下文 token）
...
| 实施角色最小读取并提交候选 | public | not_run | 未运行 | — | — | pending |
| 候选自审被机器拒绝 | public | not_run | 未运行 | — | — | pending |
| 范围内测试失败继续诊断 | public | not_run | 未运行 | — | — | pending |
| 真实契约变化触发熔断 | public | not_run | 未运行 | — | — | pending |
...
| 最终评审识别候选漂移 | public | not_run | 未运行 | — | — | pending |
