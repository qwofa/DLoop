...
This distribution entry point installs v4.0.1 without changing its payload.
...
def main():
    ...
    parser.add_argument("--archive", type=Path, help="Use a downloaded v4.0.1 source ZIP")
