...
This distribution entry point installs v3.8.0 without changing its payload.
...
def main():
    ...
    parser.add_argument("--archive", type=Path, help="Use a downloaded v3.8.0 source ZIP")
