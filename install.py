...
This distribution entry point installs v3.9.4 without changing its payload.
...
def main():
    ...
    parser.add_argument("--archive", type=Path, help="Use a downloaded v3.9.4 source ZIP")
